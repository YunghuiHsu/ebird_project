...
def get_args_parser():
    parser = argparse.ArgumentParser('Resnet50 for image classification', add_help=False)
    ...
    # Dataset parameters
    parser.add_argument('--data_path', default='../iNaturalist_2021', type=str,
                        help='dataset path')
    parser.add_argument('--nb_classes', default=1486, type=int,
...
def main(args):
    ...
    # Data Augmentation : following linear probe - weak augmentation
