...
def get_args_parser():
    parser = argparse.ArgumentParser('Resnet50  fine-tuning for image classification', add_help=False)
    ...
    # Dataset parameters
    parser.add_argument('--data_path', default='../../share/iNaturalist_2021', type=str,
                        help='dataset path')
...
def main(args):
    ...
    if args.resume :
        ...
        print("Load resumed checkpoint from: %s" % args.resume)
